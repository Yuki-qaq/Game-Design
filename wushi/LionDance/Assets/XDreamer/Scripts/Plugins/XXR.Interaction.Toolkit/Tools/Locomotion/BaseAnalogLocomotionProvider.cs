...
namespace XCSJ.PluginXXR.Interaction.Toolkit.Tools.Locomotion
{
    ...
    public abstract class BaseAnalogLocomotionProvider : InteractProvider, IAnalogLocomotionProviderIO
    {
        /// <summary>
        /// 提供者
        /// </summary>
        ...
        private void Regist()
        {
            ...
            Unregist();
            if (locomotionProvider && locomotionProvider.Regist(this))
            {
        ...
        private void Unregist()
        {
            if (registedProvider)
            {
                registedProvider.Unregist(this);
        ...
        public abstract void UpdateProvider(AnalogLocomotionProvider analogLocomotionProvider);
    }
    ...
    public interface IAnalogLocomotionProviderIO
    {
        ...
        /// </summary>
        /// <param name="analogLocomotionProvider"></param>
        void UpdateProvider(AnalogLocomotionProvider analogLocomotionProvider);
    }
}
