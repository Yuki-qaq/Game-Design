...
namespace XCSJ.EditorOptiTrack
{
    ...
    public class OptiTrackManagerInspector : BaseManagerInspector<OptiTrackManager>
    {
        ...
        public static void InitMacro()
        {
            ...
            {
                EditorHelper.ApplyThirdPartyConfig(typeof(OptiTrackManagerInspector), UnityPackageVersion);
        ...
        [LanguageTuple("Recommend using the OptiTrack plugin package version: ", "推荐使用OptiTrack插件包版本：")]
        public override void OnInspectorGUI()
        {
            UICommonFun.RichHelpBox(Tr("Recommend using the OptiTrack plugin package version: ") + UnityPackageVersion, MessageType.Info);
