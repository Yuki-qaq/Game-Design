...
namespace XCSJ.PluginHTCVive.Base
{
    ...
    public static class HTCViveProAxisAndButtonExtension
    {
        ...
        /// <returns></returns>
        public static bool TryGetAxis2DValue(this EViveProAxis2D axisArea, EXRDeviceType deviceType, out Vector2 value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool GetAbsValue(this EViveProAxisAndButton axisAndButton, EXRDeviceType deviceType, out float value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool TryGetValue(this EViveProAxisAndButton axisAndButton, EXRDeviceType deviceType, out float value)
        {
#if XDREAMER_STEAMVR
        ...
        /// <returns></returns>
        public static bool IsPressed(this EViveProAxisAndButton axisAndButton, EXRDeviceType deviceType, float deadZone = 0.5f)
        {
#if XDREAMER_STEAMVR
            if (SteamVRHelper.InitSteamVRInput())
            {
