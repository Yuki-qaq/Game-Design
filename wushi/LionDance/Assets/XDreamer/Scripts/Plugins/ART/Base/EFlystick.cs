...
namespace XCSJ.PluginART.Base
{
    ...
    public enum EFlystick1Switchs
    {
        ...
        /// </summary>
        [Name("前开关(红色)")]
        [Tip("可称开关或按钮", "It can be called switch or button")]
        [ID6df(0)]
        [ID6df2(0)]
        [Code6df(0x01)]
        [Code6df2(0x01)]
        ...
        /// </summary>
        [Name("帽子开关(黑色)左")]
        [Tip("第一控制器，模拟控制数值[0.0, 1.0]", "First controller, analog control value [0.0, 1.0]")]
        [ID6df(4)]
        [ID6df2(4)]
        [Code6df(0x20)]
        [Code6df2(0x20)]
        ...
        /// </summary>
        [Name("帽子开关(黑色)右")]
        [Tip("第一控制器，模拟控制数值[-1.0, 0.0]", "First controller, analog control value [- 1.0, 0.0]")]
        [ID6df(5)]
        [ID6df2(5)]
        [Code6df(0x80)]
        [Code6df2(0x80)]
        ...
        /// </summary>
        [Name("帽子开关(黑色)上")]
        [Tip("第二控制器，模拟控制数值[0.0, 1.0]", "Second controller, analog control value [0.0, 1.0]")]
        [ID6df(6)]
        [ID6df2(6)]
        [Code6df(0x40)]
        [Code6df2(0x40)]
        ...
        /// </summary>
        [Name("帽子开关(黑色)下")]
        [Tip("第二控制器，模拟控制数值[-1.0, 0.0]", "Second controller, analog control value [- 1.0, 0.0]")]
        [ID6df(7)]
        [ID6df2(7)]
        [Code6df(0x10)]
        [Code6df2(0x10)]
    ...
    public static class FlystickHelper
    {
        ...
        private static bool IsPressedInternal(Enum flystickButton, ARTStreamClient streamClient, int flystickID, Vector2 deadZone, out int pressedFlystickID, out int pressedFlystickSwitchs)
        {
            pressedFlystickID = -1;
                ...
                default:
                    {
                        if (streamClient.GetLatestFlyStickState(flystickID) is ARTFlyStickState data)
                        {
                            switch (flystickButton.GetHashCode())
                            {
                                ...
                                default:
                                    {
                                        if (data.IsPressed(flystickButton, deadZone))
                                        {
        ...
        /// <returns></returns>
        public static bool IsPressed1(this EFlystick1Switchs flystick1Switchs, ARTStreamClient streamClient, int flystickID, Vector2 deadZone)
        {
        ...
        /// <returns></returns>
        public static bool IsPressed(this EFlystick1Switchs flystick1Switchs, ARTStreamClient streamClient, int flystickID, Vector2 deadZone, out int pressedFlystickID, out int pressedFlystickSwitchs)
        {
        ...
        /// <param name="deadZone">死区：对于摇杆的值超过本死区值时，认为事件成立；</param>
        /// <returns></returns>
        public static bool IsPressed(this EFlystick2Switchs flystick2Switchs, ARTStreamClient streamClient, int flystickID, Vector2 deadZone)
        {
        ...
        /// <param name="pressedFlystickSwitchs">被按压的Flystick按钮</param>
        /// <returns></returns>
        public static bool IsPressed(this EFlystick2Switchs flystick2Switchs, ARTStreamClient streamClient, int flystickID, Vector2 deadZone, out int pressedFlystickID, out int pressedFlystickSwitchs)
        {
        ...
        /// <param name="deadZone">死区：对于摇杆的值超过本死区值时，认为事件成立；</param>
        /// <returns></returns>
        public static bool IsPressed(this EFlystick3Switchs flystick3Switchs, ARTStreamClient streamClient, int flystickID, Vector2 deadZone)
        {
        ...
        /// <param name="pressedFlystickSwitchs">被按压的Flystick按钮</param>
        /// <returns></returns>
        public static bool IsPressed(this EFlystick3Switchs flystick3Switchs, ARTStreamClient streamClient, int flystickID, Vector2 deadZone, out int pressedFlystickID, out int pressedFlystickSwitchs)
        {
    ...
    public class FlystickButton : IToFriendlyString
    {
        ...
        /// Flystick编号
        /// </summary>
        public int flysitckID { get => _flysitckID; set => _flysitckID = value; }
...
#endif
        [Json(false)]
        public EFlystick _flystick = EFlystick.None;

        /// <summary>
        /// Flystick手柄
        /// </summary>
        public EFlystick flystick { get => _flystick; set => _flystick = value; }
        ...
        /// Flystick1按钮
        /// </summary>
        public EFlystick1Switchs flystick1Switchs { get => _flystick1Switchs; set => _flystick1Switchs = value; }
        ...
        /// Flystick2按钮
        /// </summary>
        public EFlystick2Switchs flystick2Switchs { get => _flystick2Switchs; set => _flystick2Switchs = value; }
        ...
        /// Flystick3按钮
        /// </summary>
        public EFlystick3Switchs flystick3Switchs { get => _flystick3Switchs; set => _flystick3Switchs = value; }

        /// <summary>
        /// Flystick按钮
        /// </summary>
        [Json(false)]
        public Enum flystickButton
        {
            get
            {
                switch(_flystick)
                {
                    case EFlystick.Flystick1: return _flystick1Switchs;
                    case EFlystick.Flystick2: return _flystick2Switchs;
                    case EFlystick.Flystick3: return _flystick3Switchs;
                }
                return EFlystick2Switchs.None;
            }
        }

        /// <summary>
        /// 死区：对于摇杆的值（源值）值小于死区小值时，则认为0值；在死区区间内时，如果做按钮则为1且认为事件成立，如果做模拟量，则对源值做0到1的线性补间值；
        /// </summary>
        [Name("死区")]
        [Tip("对于摇杆的值（源值）值小于死区小值时，则认为0值；在死区区间内时，如果做按钮则为1且认为事件成立，如果做模拟量，则对源值做0到1的线性补间值；", "When the value (source value) of the joystick is less than the small value of the dead band, it is considered as a 0 value; When in the dead band range, if the button is pressed, it is 1 and the event is considered valid. If the analog quantity is used, a linear interpolation value of 0 to 1 is applied to the source value;")]
        [Json(false)]
#if UNITY_2019_4_OR_NEWER
        [LimitRange(-1, 1)]
        public Vector2 _deadZone = new Vector2(0.5f, 1);

        /// <summary>
        /// 死区
        /// </summary>
        [Json(exportString = true)]
        public Vector2 deadZone { get => _deadZone; set => _deadZone = value; }
#else
        public V2F _deadZone = new V2F(0.5f, 1);
        ...
        /// <param name="streamClient"></param>
        /// <returns></returns>
        public float GetValue(ARTStreamClient streamClient)
        {
            var state = streamClient.GetLatestFlyStickState(_flysitckID);
            if (state == null) return 0;
            return (float)state.GetAbsValue(flystickButton, _deadZone);
        }
        ...
        /// </summary>
        /// <param name="streamClient"></param>
        /// <param name="dstValueRange"></param>
        /// <returns></returns>
        public float GetDstValue(ARTStreamClient streamClient, Vector2 dstValueRange)
        {
            var state = streamClient.GetLatestFlyStickState(_flysitckID);
            if (state == null) return 0;

            return (float)state.GetDstValue(flystickButton, _deadZone, dstValueRange);
        }
        ...
        public string ToFriendlyString()
        {
            switch (_flystick)
            {
                case EFlystick.Flystick1: return NameCache.Get(_flystick1Switchs);
                case EFlystick.Flystick2: return NameCache.Get(_flystick2Switchs);
                case EFlystick.Flystick3: return NameCache.Get(_flystick3Switchs);
            }
            return NameCache.Get(_flystick);
        }
#endif
    }
    ...
    public enum EDataType
    {
        ...
        /// </summary>
        [Name("刚体")]
        [Tip("具有6自由度信息的刚体", "Rigid body with 6-DOF information")]
        Body,
        ...
        /// </summary>
        [Name("FlyStick")]
        [Tip("具有6自由度信息的FlyStick交互输入设备", "Flystick interactive input device with 6-DOF information")]
        FlyStick,
    }
    ...
    public class ARTClientConfig
    {
        ...
        /// 服务器端口
        /// </summary>
        public int serverPort { get; set; } = 50105;
        ...
        /// 远程类型
        /// </summary>
        public ERemoteType remoteType { get; set; } = ERemoteType.Unknow;
    }
