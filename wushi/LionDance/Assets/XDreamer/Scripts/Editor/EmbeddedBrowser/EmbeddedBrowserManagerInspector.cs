...
namespace XCSJ.EditorEmbeddedBrowser
{
    ...
    public class EmbeddedBrowserManagerInspector : BaseManagerInspector<EmbeddedBrowserManager>
    {
        ...
        private const string UnityPackageVersion = "3.1.0";

        /// <summary>
        /// 当绘制检查器GUI
        /// </summary>
        [LanguageTuple("Please install (or update) [Embedded Browser] plug-in [3.1.0] (included) or higher!", "请安装(或更新)【嵌入式浏览器】插件[3.1.0](含)或更高版本！")]
        [LanguageTuple("Recommend using the Embedded Browser plugin package version: ", "推荐使用Embedded Browser插件包版本：")]
        public override void OnInspectorGUI()
        {
            UICommonFun.RichHelpBox(Tr("Recommend using the Embedded Browser plugin package version: ") + UnityPackageVersion, MessageType.Info);
