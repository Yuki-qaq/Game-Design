...
namespace XCSJ.PluginCameras.Characters
{
    ...
    public static class CharacterHelper
    {
        ...
        /// <param name="addStandardInput"></param>
        /// <param name="addAngentInput"></param>
        /// <returns></returns>
        public static XCharacterController CreateCharacterController(string name, bool multiGameObjectMode = true, bool addStandardInput = true, bool addAngentInput = false)
        {
            //创建游戏对象
            ...
            if (multiGameObjectMode)
            {
                ...
                if (addStandardInput)
                {
                    characterController.characterTransformer.XAddComponent<CharacterMoveByInput>();
                    characterController.characterTransformer.XAddComponent<CharacterMoveSpeedByInput>();
                    characterController.characterTransformer.XAddComponent<CharacterRotateByInput>();
                    characterController.characterTransformer.XAddComponent<CharacterRotateByTouch>();
                }
                if (addAngentInput)
                {
                    characterController.characterTransformer.XAddComponent<CharacterMoveInAgentByInput>();
                }
            }
            else
            {
                //添加各种控制器组件
                characterController.XAddComponent<CharacterTransformer>();
                ...
                if (addStandardInput)
                {
                    ...
                    characterController.XAddComponent<CharacterRotateByTouch>();
                }
                if (addAngentInput)
                {
                    characterController.XAddComponent<CharacterMoveInAgentByInput>();
                }
            }
        ...
        /// <param name="addAngentInput"></param>
        /// <returns></returns>
        public static XCharacterController CreateCharacterControllerWithCameraController(string name, bool multiGameObjectMode = true, bool addStandardInput = true, bool addAngentInput = false)
        {
            //创建角色控制器
            var characterController = CreateCharacterController(name, multiGameObjectMode, addStandardInput, addAngentInput);
            ...
            var cameraControllerEvent = cameraController.XGetOrAddComponent<CameraControllerEvent>();
            cameraControllerEvent.Add(ECameraControllerEvent.OnSwitchedToCurrent, characterController.gameObject, true);
            cameraControllerEvent.Add(ECameraControllerEvent.OnWillSwitchToLast, characterController.gameObject, false);
    ...
    public static class CharacterCategory
    {
        ...
        /// 标题
        /// </summary>
        public const string Title = ToolsCategory.ToolsPrefix + "角色";
    }
}
