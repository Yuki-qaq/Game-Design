...
namespace XCSJ.PluginCNScripts.Base
{
    /// <summary>
    /// 引用变量集合
    /// </summary>
    ...
    public class ReferenceVariable : Variable<ReferenceVariable, ReferenceHierarchyVar>
    {
        ...
        public override object SetValue(object value)
        {
            ...
            {
                ex.HandleException(nameof(SetValue));
                return default;
            }
            finally
            {
        ...
        private static string ToVarName(IVarContext varContext, string srcText, UnityEngine.Object unityObject) => unityObject ? ToVarNameDirect(varContext, srcText, unityObject) : default;

        private static string ToVarNameDirect(IVarContext varContext, string srcText, UnityEngine.Object unityObject)
        {
            var varName = MD5Helper.Get32(srcText);
            varContext.TrySetOrAddSetHierarchyVarValue(ScriptHelper.VarFlag + varName + EVarScope.Reference.ToVarScopeString(), unityObject);
            return varName;
        }

        private static string GetScriptParamString(IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult, bool tryCalculate)
        {
            var expressionStringAnalysisResult = varStringAnalysisResult.varNameKey.keyExpressionStringAnalysisResult;
            if (tryCalculate)
            {
                return expressionStringAnalysisResult.TryCalculateExpressionByString(varContext.scriptDriver, out var calculateResult) ? calculateResult : expressionStringAnalysisResult.expressionCalculateString;
            }
            else
            {
                return expressionStringAnalysisResult.expressionCalculateString;
            }
        }

        private static string VarName(IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult, Func<string, UnityEngine.Object> func, bool tryCalculate)
        {
            var str = GetScriptParamString(varContext, varStringAnalysisResult, tryCalculate);
            return ToVarName(varContext, str, func(str));
        }
        ...
        /// <param name="varNameType"></param>
        /// <param name="varContext"></param>
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "GO")]
        public static string UnityGameObjectVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName( varContext, varStringAnalysisResult, s => CommonFun.StringToGameObject(s), true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_GO", "_GO_", "GO_")]
        public static string UnityGameObjectVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName( varContext, varStringAnalysisResult, s => CommonFun.StringToGameObject(s), false);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "C")]
        public static string UnityComponentVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName( varContext, varStringAnalysisResult, s => CommonFun.StringToGameObjectComponent(s),true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_C", "_C_", "C_")]
        public static string UnityComponentVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName( varContext, varStringAnalysisResult, s => CommonFun.StringToGameObjectComponent(s),false);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "XS")]
        public static string XDreamerStateVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToState(s), true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_XS", "_XS_", "XS_")]
        public static string XDreamerStateVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToState(s), false);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "XSC")]
        public static string XDreamerStateComponentVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToStateComponent(s),true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_XSC", "_XSC_", "XSC_")]
        public static string XDreamerStateComponentVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToStateComponent(s),false);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "XT")]
        public static string XDreamerTransitionVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToTransition(s),true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_XT", "_XT_", "XT_")]
        public static string XDreamerTransitionVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToTransition(s),false);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "XTC")]
        public static string XDreamerTransitionComponentVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToTransitionComponent(s),true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_XTC", "_XTC_", "XTC_")]
        public static string XDreamerTransitionComponentVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToTransitionComponent(s),false);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "XSG")]
        public static string XDreamerStateGroupVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToStateGroup(s),true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_XSG", "_XSG_", "XSG_")]
        public static string XDreamerStateGroupVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToStateGroup(s),false);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "XSGC")]
        public static string XDreamerStateGroupComponentVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToStateGroupComponent(s),true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_XSGC", "_XSGC_", "XSGC_")]
        public static string XDreamerStateGroupComponentVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => VarName(varContext, varStringAnalysisResult, s => SMSHelper.StringToStateGroupComponent(s), false);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "guid")]
        public static string GuidVarName(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => GuidVarName(varContext, varStringAnalysisResult, true);
        ...
        /// <param name="varStringAnalysisResult"></param>
        /// <returns></returns>
        [VarNameExtension(EVarScope.Reference, "_guid", "_guid_", "guid_")]
        public static string GuidVarNameNoCalculate(EVarScope varScope, string varNameType, IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult) => GuidVarName(varContext, varStringAnalysisResult, false);

        static string GuidVarName(IVarContext varContext, VarStringAnalysisResult varStringAnalysisResult, bool tryCalculate)
        {
            return VarName(varContext, varStringAnalysisResult, s =>
            {
                if (guids.TryGetValue(s, out var o) && o && o.guid == s) return o;
                o = ComponentCache.GetComponents<ExtensionalInteractObject>().FirstOrDefault(o1 => o1.guid == s);
                if (o)
                {
                    guids[s] = o;
                    return o;
        ...
        static Dictionary<string, ExtensionalInteractObject> guids = new Dictionary<string, ExtensionalInteractObject>();
    ...
    public class ReferenceHierarchyVar : IHierarchyVar
    {
        ...
        public bool TrySetValue(object value, EVarType varType)
        {
            ...
            if (Converter.instance.TryConvertTo(value, defineValueType, out var o))
            {
                ...
                catch (Exception ex) { ex.HandleException(nameof(TrySetValue)); }
            }
            return false;
        }
