...
namespace XCSJ.Extension.Base.Kernel
{
    ...
    public class DefaultUnityObjectHandler : InstanceClass<DefaultUnityObjectHandler>, IUnityObjectHandler
    {
        ...
        /// <returns></returns>
        public bool IsPartOfPrefabAsset(UnityEngine.Object componentOrGameObject) => false;
        ...
        /// <returns></returns>
        public string ToJson<T>(IEnumerable<T> objects, GameObject relativeGameObject) where T : ScriptableObject => "";
        ...
        /// <param name="relativeGameObject"></param>
        /// <returns></returns>
        public List<ScriptableObject> FromJson(string json, GameObject relativeGameObject) => default;
    }
}
