...
namespace XCSJ.PluginTools.Draggers
{
    ...
    public sealed class CombinationDragToolController : Interactor
    {
        ...
        /// 悬停器
        /// </summary>
        [Group("悬停设置", textEN = "Hover Settings", defaultIsExpanded = false)]
        [Name("悬停器")]
        [ValidityCheck(EValidityCheckType.NotNull)]
        public Hover _hover;
        ...
        /// 选择集修改器
        /// </summary>
        [Group("选择设置", textEN = "Select Settings", defaultIsExpanded = false)]
        [Name("选择集修改器")]
        [ValidityCheck(EValidityCheckType.NotNull)]
        ...
        /// 射线拖拽摆放工具
        /// </summary>
        [Group("拽摆设置", textEN = "Drag Settings", defaultIsExpanded = false)]
        [Name("射线拖拽摆放工具")]
        [ValidityCheck(EValidityCheckType.NotNull)]
