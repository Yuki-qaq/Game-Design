...
namespace XCSJ.PluginZVR.Tools
{
    ...
    /// </summary>
    [Name("姿态通过ZVR")]
    [Tip("通过ZVR模拟控制器姿态的输入输出", "The input and output of controller attitude are simulated by ZVR")]
    ...
    public class PoseByZVR : BaseAnalogProvider, IPoseProvider, IZVRObject
    {
#if XDREAMER_ZVR
