...
namespace XCSJ.PluginXXR.Interaction.Toolkit.Tools.Controllers
{
    ...
    /// </summary>
    [Name("姿态通过XR设备")]
    [Tip("通过XR设备模拟控制器姿态的输入输出", "The input and output of controller attitude are simulated by XR device")]
    ...
    public class PoseByXRDevice : BaseAnalogProvider, IPoseProvider
    {
        /// <summary>
        /// 设备类型
        /// </summary>
        [Name("设备类型")]
        [EnumPopup]
        public EXRDeviceType _deviceType = EXRDeviceType.Left;
