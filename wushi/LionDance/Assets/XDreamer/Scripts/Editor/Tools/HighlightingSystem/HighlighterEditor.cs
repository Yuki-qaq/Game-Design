...
using UnityEngine;
using XCSJ.PluginTools.HighlightingSystem;

namespace XCSJ.EditorTools.HighlightingSystem
{
	/// <summary>
	/// 高亮编辑器
	/// </summary>
	[CustomEditor(typeof(XCSJ.PluginTools.HighlightingSystem.Highlighter)), CanEditMultipleObjects]
	public class HighlighterEditor : Editor
	{
		...
		private XCSJ.PluginTools.HighlightingSystem.Highlighter highlighter;
		...
		void OnEnable()
		{
			highlighter = target as XCSJ.PluginTools.HighlightingSystem.Highlighter;
