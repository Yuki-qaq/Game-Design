...
namespace XCSJ.PluginCameras.Characters.Tools
{
    ...
    /// 基础角色旋转控制器
    /// </summary>
    public abstract class BaseCharacterRotateController : BaseCharacterTransformInputController
    {
        /// <summary>
        /// 速度信息
        /// </summary>
        ...
        {
            mainController.Rotate(_offset, (int)_rotateMode, this);
    ...
    /// 基础角色移动控制器
    /// </summary>
    public abstract class BaseCharacterMoveController : BaseCharacterTransformInputController { }
}
