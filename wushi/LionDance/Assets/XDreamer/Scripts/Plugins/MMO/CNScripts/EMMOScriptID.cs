...
namespace XCSJ.PluginMMO.CNScripts
{
    /// <summary>
    /// MMO脚本ID
    /// </summary>
    [Name("MMO脚本ID")]
    [ScriptEnum(typeof(MMOManager))]
    public enum EMMOScriptID
    {
        ...
        /// 多人在线MMO脚本
        /// </summary>
        [ScriptName("多人在线MMO脚本", nameof(MMOCategory), EGrammarType.Category)]
        ...
        /// MMO游戏对象克隆
        /// </summary>
        [ScriptName("MMO游戏对象克隆", nameof(MMOGameObjectClone))]
        ...
        /// MMO游戏对象删除
        /// </summary>
        [ScriptName("MMO游戏对象删除", nameof(MMOGameObjectDestory))]
        ...
        /// MMO获取网络属性
        /// </summary>
        [ScriptName("MMO获取网络属性", nameof(MMOGetNetProperty))]
        ...
        /// MMO设置网络属性
        /// </summary>
        [ScriptName("MMO设置网络属性", nameof(MMOSetNetProperty))]
        ...
        /// MMO获取网络状态
        /// </summary>
        [ScriptName("MMO获取网络状态", nameof(MMOGetNetState))]
        ...
        /// MMO获取Ping
        /// </summary>
        [ScriptName("MMO获取Ping", nameof(MMOGetPing))]
        ...
        [ScriptParams(1, EParamType.Combo, "控制命令:", "启动", "停止", "进入房间", "退出房间")]
        [ScriptReturn("成功返回 #True; 失败返回 #False ;")]
        #endregion
        MMOControl,
        ...
        [ScriptParams(1, EParamType.Combo, "信息类型:", "应用名", "应用编号", "应用版本", "房间编号", "房间名", "是否需要密码", "在线人数", "总人数")]
        ...
        [ScriptDescription("创建玩家；使用昵称创建玩家")]
        [ScriptParams(1, EParamType.String, "玩家昵称:")]
        [ScriptReturn("成功返回  #True; 失败返回 #False ;")]
        #endregion
        MMOCreatePlayer,
        ...
        [ScriptParams(1, EParamType.GameObjectComponent, "网络聊天:", typeof(NetChat))]
        [ScriptParams(2, EParamType.Combo, "信息类型:", "文本", "音频")]
        [ScriptParams(3, EParamType.String, "文本:")]
        [ScriptParams(4, EParamType.UnityAssetObject, "音频:", typeof(AudioClip))]
        [ScriptReturn("成功返回  #True; 失败返回 #False ;")]
        #endregion
        MMOSendMsg,
        ...
        /// 获取本地玩家
        /// </summary>
        [ScriptName("获取本地玩家", nameof(MMOGetLocalPlayer))]
        [ScriptDescription("获取本地玩家；")]
        [ScriptParams(1, EParamType.Combo, "信息类型:", "组件", "游戏对象")]
        [ScriptReturn("成功返回  所需信息; 失败返回 #False ;")]
        #endregion
        MMOGetLocalPlayer
    }
