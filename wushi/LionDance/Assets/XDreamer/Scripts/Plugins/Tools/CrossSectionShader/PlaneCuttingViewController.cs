        ...
        public Vector3 xPlaneAngle
        {
            get
            {
                if (initRecordXPlaneAngle)
                {
                    ...
                    recordXPlaneAngle = AngleClampN180ToP180(_xPlane.transform.eulerAngles);
                }
        ...
        public Vector3 yPlaneAngle
        {
            get
            {
                if (initRecordYPlaneAngle)
                {
                    ...
                    recordYPlaneAngle = AngleClampN180ToP180(_yPlane.transform.eulerAngles);
                }
        ...
        public Vector3 zPlaneAngle
        {
            get
            {
                if (initRecordZPlaneAngle)
                {
                    ...
                    recordZPlaneAngle = AngleClampN180ToP180(_zPlane.transform.eulerAngles);
                }
