    ...
    public static class SamsungWMRExtension
    {
        ...
        public static bool TryGetAxis2DValue(this ESamsungWMRAxis2D axisArea, EHandRule handType, out Vector2 value)
        {
            switch (handType)
            {
                ...
                case EHandRule.Any:
                    {
                        return TryGetAxis2DValue(axisArea, EXRDeviceType.Left, out value) || TryGetAxis2DValue(axisArea, EXRDeviceType.Right, out value);
                    }
                case EHandRule.All:
                    {
                        var rs1 = TryGetAxis2DValue(axisArea, EXRDeviceType.Left, out var leftValue);
                        var rs2 = TryGetAxis2DValue(axisArea, EXRDeviceType.Right, out var rightValue);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool TryGetAxis2DValue(this ESamsungWMRAxis2D axisArea, EXRDeviceType deviceType, out Vector2 value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool TryGetValue(this ESamsungWMRAxisAndButton axisAndButton, EXRDeviceType deviceType, out float value)
        {
#if XDREAMER_XR_INTERACTION_TOOLKIT
            var dev = deviceType.GetDevice();
        ...
        public static bool TryGetValue(this ESamsungWMRAxisAndButton axisAndButton, EHandRule handRule, out float value)
        {
            switch (handRule)
            {
                case EHandRule.Left: return axisAndButton.TryGetValue(EXRDeviceType.Left, out value);
                case EHandRule.Right: return axisAndButton.TryGetValue(EXRDeviceType.Right, out value);
                case EHandRule.Any:
                    {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool TryGetAbsValue(this ESamsungWMRAxisAndButton axisAndButton, EXRDeviceType deviceType, out float value)
        {
        ...
        /// <returns></returns>
        public static bool IsPressed(this ESamsungWMRAxisAndButton axisAndButton, EXRDeviceType deviceType, float deadZone = 0.5f)
        {
#if XDREAMER_XR_INTERACTION_TOOLKIT
            var dev = deviceType.GetDevice();
            switch (axisAndButton)
