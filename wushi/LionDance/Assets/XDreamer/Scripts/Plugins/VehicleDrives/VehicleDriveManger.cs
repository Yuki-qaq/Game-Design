...
namespace XCSJ.PluginVehicleDrive
{
    ...
    [Name(VehicleDriveCategory.Title)]
    [Tip("模拟摩托车、三轮车、汽车、卡车或更多轮的车辆的驾驶控制", "Simulate the driving control of motorcycles, tricycles, cars, trucks or vehicles with more wheels")]
