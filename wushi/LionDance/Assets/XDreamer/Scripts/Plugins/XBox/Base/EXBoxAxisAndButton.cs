...
namespace XCSJ.PluginXBox.Base
{
    ...
    public class EXBoxAxisAndButtonAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="e"></param>
        /// <param name="defaultEXBoxAxisAndButton"></param>
        /// <returns></returns>
    ...
    public static class EXBoxAxisAndButtonExtension
    {
        ...
        /// </summary>
        /// <param name="axisAndButton"></param>
        /// <param name="deadZoneRange"></param>
        /// <param name="dstValueRange"></param>
        /// <returns></returns>
        public static float GetDstValue(this EXBoxAxisAndButton axisAndButton, Vector2 deadZoneRange, Vector2 dstValueRange)
        {
            return axisAndButton.GetValue().ToDstValue(deadZoneRange.x, deadZoneRange.y, dstValueRange.x, dstValueRange.y);
        }
        ...
        /// <param name="axisAndButton"></param>
        /// <param name="deadZoneRange"></param>
        /// <returns>返回的值范围[0, 1]</returns>
        public static float GetValue(this EXBoxAxisAndButton axisAndButton, Vector2 deadZoneRange) => axisAndButton.GetValue().Normalization(deadZoneRange.x, deadZoneRange.y);
        ...
        /// </summary>
        /// <param name="axisAndButton"></param>
        /// <param name="pressedRange">对于摇杆类的值在按压区间内时，则认为按压</param>
        /// <returns></returns>
        public static bool IsPressed(this EXBoxAxisAndButton axisAndButton, Vector2 pressedRange)
        {
#if XDREAMER_INPUT_SYSTEM_XBOX_WINDOWS
            ...
            var value = Mathf.Abs(axisAndButton.GetValue());
            return value >= pressedRange.x && value <= pressedRange.y;
#endif
        }
        ...
        /// </summary>
        /// <param name="axisAndButton"></param>
        /// <param name="deadZone">对于摇杆类的值在大于等于死区值时，则认为按压</param>
        /// <returns></returns>
