...
namespace XCSJ.PluginXGUI.Windows.ColorPickers
{
    ...
    public class ColorPicker : View
    {
        ...
        [Readonly]
        [Name("上一次数据")]
        public Color _lastData = Color.white;
        ...
        [Readonly]
        [Name("原始数据")]
        public Color _originalData = Color.white;
        ...
        public override void OnDeserialize(Data data)
        {
            ...
            color = _lastData = Converter.instance.ConvertTo<Color>(data.data);
        }
