...
namespace XCSJ.EditorCameras.Tools
{
    ...
    public static class ToolsMenu
    {
        ...
        [Manual(typeof(ToolsMenu), nameof(FlyCamera))]
        ...
        /// <returns></returns>
        [Name("定点相机")]
        [XCSJ.Attributes.Icon(EIcon.FixCamera)]
        [Tool(CameraCategory.Title, nameof(CameraManager), rootType = typeof(CameraManager), groupRule = EToolGroupRule.None)]
        [RequireManager(typeof(CameraManager))]
        [Manual(typeof(ToolsMenu), nameof(FixedCamera))]
        ...
        /// <returns></returns>
        [Name("定点注视相机")]
        [XCSJ.Attributes.Icon(EIcon.FixedLookAtCamera)]
        [Tool(CameraCategory.Title, nameof(CameraManager), rootType = typeof(CameraManager), groupRule = EToolGroupRule.None)]
        [RequireManager(typeof(CameraManager))]
        [Manual(typeof(ToolsMenu), nameof(FixedLookAtCamera))]
        ...
        /// <returns></returns>
        [Name("跟随相机")]
        [XCSJ.Attributes.Icon(EIcon.FollowCamera)]
        [Tool(CameraCategory.Title, nameof(CameraManager), rootType = typeof(CameraManager), groupRule = EToolGroupRule.None)]
        [RequireManager(typeof(CameraManager))]
        [Manual(typeof(ToolsMenu), nameof(FollowCamera))]
        ...
        /// <returns></returns>
        [Name("绕物相机")]
        [XCSJ.Attributes.Icon(EIcon.AroundCamera)]
        [Tool(CameraCategory.Title, nameof(CameraManager), rootType = typeof(CameraManager), groupRule = EToolGroupRule.None)]
        [RequireManager(typeof(CameraManager))]
        [Manual(typeof(ToolsMenu), nameof(AroundCamera))]
        ...
        [Tool(CameraCategory.Title, nameof(CameraManager), rootType = typeof(CameraManager), groupRule = EToolGroupRule.None)]
        [RequireManager(typeof(CameraManager))]
        [Manual(typeof(ToolsMenu), nameof(MoveAroundCamera))]
        ...
        [Tool(CameraCategory.Title, nameof(CameraManager), rootType = typeof(CameraManager), groupRule = EToolGroupRule.None)]
        [RequireManager(typeof(CameraManager))]
        [Manual(typeof(ToolsMenu), nameof(MoveFlyCamera))]
