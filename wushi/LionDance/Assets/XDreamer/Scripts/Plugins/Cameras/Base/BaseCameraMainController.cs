...
namespace XCSJ.PluginCameras.Base
{
    ...
    public abstract class BaseCameraMainController : BaseMainController, ICameraMainController, ICameraOwner, IComponentHasOwner<ICameraOwner>, ITool, ITarget
    {
        ...
        /// 移动速度单值
        /// </summary>
        public float moveSpeedSingleValue
        {
            get => (moveSpeedCoefficient.x + moveSpeedCoefficient.y + moveSpeedCoefficient.z) / 3f;
            set => moveSpeedCoefficient = new Vector3(value, value, value);
        }
        ...
        /// 移动速度单值
        /// </summary>
        public float rotateSpeedSingleValue
        {
            get => (rotateSpeedCoefficient.x + rotateSpeedCoefficient.y + rotateSpeedCoefficient.z) / 3f;
            set => rotateSpeedCoefficient = new Vector3(value, value, value);
        }
