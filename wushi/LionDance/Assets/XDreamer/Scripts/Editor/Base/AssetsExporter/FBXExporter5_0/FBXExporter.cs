...
namespace XCSJ.EditorExtension.AssetsExporter.FBXExporter5_0
{
    /// <summary>
    /// FBX导出器
    /// </summary>
    public class FBXExporter
    {
        ...
        {
            GameObject obj = objectToDuplicate.XCloneObject();
        ...
        /// 导出FBX
        /// </summary>
        /// <param name="folderPathForFBX"></param>
        /// <param name="fbxName"></param>
        /// <param name="selectedObjects"></param>
        /// <param name="addObjectInHierarchy"></param>
