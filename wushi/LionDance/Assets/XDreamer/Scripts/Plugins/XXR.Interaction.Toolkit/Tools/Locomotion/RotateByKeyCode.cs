...
{
	/// <summary>
	/// 旋转通过键码:通过键码模拟运动提供者旋转的输入输出
	/// </summary>
	[Name("旋转通过键码")]
	[Tip("通过键码模拟运动提供者旋转的输入输出", "Simulate the input and output of the rotation of the motion provider through the key code")]
	[Tool(XRITHelper.InteractInput, nameof(AnalogLocomotionProvider))]
	[XCSJ.Attributes.Icon(EIcon.Keyboard)]
	public class RotateByKeyCode : BaseRotateIO
	{
		/// <summary>
		/// 正向设置
		/// </summary>
	...
	/// 基础旋转IO
	/// </summary>
	public abstract class BaseRotateIO : BaseAnalogLocomotionProvider
	{
		/// <summary>
		/// 旋转速度
		/// </summary>
		...
		public override void UpdateProvider(AnalogLocomotionProvider analogLocomotionProvider)
		{
