...
namespace XCSJ.PluginCNScripts
{
    /// <summary>
    ...
    public static class HierarchyKeyExtensionHelper
    {
        ...
        public static void Init()
        {
            ...
            var ms = MethodHelper.GetStaticMethodsAndAttributes<HierarchyKeyAttribute>();
        ...
        {
            return methodInfo.CreateDelegate<Func<IVarContext, IHierarchyVar, string, object>>();
        }
        ...
        {
            return methodInfo.CreateDelegate<Func<IVarContext, IHierarchyVar, string, object, bool>>();
        }
