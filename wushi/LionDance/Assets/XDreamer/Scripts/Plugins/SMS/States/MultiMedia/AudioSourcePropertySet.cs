...
namespace XCSJ.PluginSMS.States.Components
{
    ...
    [Tip("控制音频源的播放、暂停、循环、设置音频剪辑、静音、音量和高音等", "Control the playback, pause and cycle of audio source, set audio clip, mute, volume and treble, etc")]
